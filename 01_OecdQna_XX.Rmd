...
source("./Rscripts/r_oecd_helper_functions.R")
...
![](./OECD_QNA_Overview//Oecd_Qna_OutputApproach.png)
...
![](./OECD_QNA_Overview//Oecd_Qna_ExpenditureApproach.png)
...
if (upd.dat) {
  save(qna.str, file = "C:/Users/Markus/Dropbox/Lehre/HfWU/Makrooekonomik2/Makrooekonomik2_Allgemein/HfWU_Makro02_Html/qna_str.RData")
} else {
  load(file = "C:/Users/Markus/Dropbox/Lehre/HfWU/Makrooekonomik2/Makrooekonomik2_Allgemein/HfWU_Makro02_Html/qna_str.RData")
}
...
load(file = "C:/Users/Markus/Dropbox/Lehre/HfWU/Makrooekonomik2/Makrooekonomik2_Allgemein/HfWU_Makro02_Html/qna_dat_00.RData")
...
loc <- c("DEU", "FRA", "ITA", "EA19", "GBR", "USA")
...
if (upd.dat) {
  save(qna.dat.00, file = "C:/Users/Markus/Dropbox/Lehre/HfWU/Makrooekonomik2/Makrooekonomik2_Allgemein/HfWU_Makro02_Html/qna_dat_00.RData")
} else {
  load("C:/Users/Markus/Dropbox/Lehre/HfWU/Makrooekonomik2/Makrooekonomik2_Allgemein/HfWU_Makro02_Html/qna_dat_00.RData")
}
...
# > Eurozone
loc <- c("EA19")
oecd.qna.out.ea19 <- oecd.qna.out(loc, sta.dat, end.dat)
# > United Kingdom
loc <- c("GBR")
...
# > Euro Area ----
grid.arrange(oecd.qna.out.ea19$plt.x, oecd.qna.out.ea19$plt.gx, ncol=2, top = "Eurozone")
# > United Kingdom ----
...
# > Euro Area ----
grid.arrange(oecd.qna.out.ea19$plt.x,ncol = 1, top = "Eurozone")
# > United Kingdom ----
...
# > Euro Area ----
grid.arrange(oecd.qna.out.ea19$plt.gx, ncol = 1, top = "Eurozone")
# > United Kingdom ----
...
ggsave(plot=oecd.qna.out.ea19$plt.gx,width=10,height=6,dpi=300,filename = "./Figures/EA19_QNA_out_gx_01.pdf")
# ggsave(plot=oecd.qna.out.gbr$plt.gx,width=10,height=6,dpi=300,filename = "./Figures/GBR_QNA_out_gx_01.pdf")

ggsave(plot=oecd.qna.out.ea19$plt.gx,width=10,height=6,dpi=300,filename = "./Figures/EA19_QNA_out_gx_01.svg")
...
# > Eurozone
loc <- c("EA19")
oecd.qna.exp.ea19 <- oecd.qna.exp(loc, sta.dat, end.dat)
# > United Kingdom
loc <- c("GBR")
...
# > Euro Area ----
grid.arrange(oecd.qna.exp.ea19$plt.x,oecd.qna.exp.ea19$plt.gx,ncol=2,top="Eurozone")
# > United Kingdom ----
...
# > Euro Area ----
grid.arrange(oecd.qna.exp.ea19$plt.x,ncol = 1, top = "Eurozone")
# > United Kingdom ----
...
# > Euro Area ----
grid.arrange(oecd.qna.exp.ea19$plt.gx, ncol = 1, top = "Eurozone")
# > United Kingdom ----
...
ggsave(plot=oecd.qna.exp.ea19$plt.gx,width=10,height=6,dpi=300,filename = "./Figures/EA19_QNA_exp_gx_01.pdf")
# ggsave(plot=oecd.qna.exp.gbr$plt.gx,width=10,height=6,dpi=300,filename = "./Figures/GBR_QNA_exp_gx_01.pdf")

ggsave(plot=oecd.qna.exp.ea19$plt.gx,width=10,height=6,dpi=300,filename = "./Figures/EA19_QNA_exp_gx_01.svg")
